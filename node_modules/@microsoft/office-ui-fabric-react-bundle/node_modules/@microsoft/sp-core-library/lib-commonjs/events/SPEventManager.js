...
var _isClearEventQueueKSActivated = function () {
    return SPKillSwitch_1.default.isActivated('cce74c23-0de4-4d05-a399-58ff80a092f1'
    /* '12/22/21', 'Clear Sticky Events Queue when requested' */
    );
};
/**
...
var SPEventManager = /** @class */ (function () {
    ...
    SPEventManager.prototype.removeEvent = function (eventName) {
        ...
        if (!_isClearEventQueueKSActivated()) {
